...
train = '../data/raw/train.csv'  # path to training file
label = '../data/raw/trainLabels.csv'  # path to label file of training data
test = '../data/raw/test.csv'  # path to testing file
